...
var EXISTS = isObject$8(document$2) && isObject$8(document$2.createElement);
...
var getBuiltIn$5 = function (namespace, method) {
  return arguments.length < 2 ? aFunction$7(path[namespace]) || aFunction$7(global$d[namespace])
    : path[namespace] && path[namespace][method] || global$d[namespace] && global$d[namespace][method];
};
...
objectGetOwnPropertyDescriptor.f = DESCRIPTORS$4 ? nativeGetOwnPropertyDescriptor : function getOwnPropertyDescriptor(O, P) {
  ...
  if (has$7(O, P)) return createPropertyDescriptor$1(!propertyIsEnumerableModule$1.f.call(O, P), O[P]);
};
...
(redefine$5.exports = function (O, key, value, options) {
  ...
  if (typeof value == 'function') {
    if (typeof key == 'string' && !has$6(value, 'name')) createNonEnumerableProperty$4(value, 'name', key);
...
var arrayMethodUsesToLength$2 = function (METHOD_NAME, options) {
  ...
  return cache[METHOD_NAME] = !!method && !fails$4(function () {
...
// `Array.prototype.includes` method
// https://tc39.github.io/ecma262/#sec-array.prototype.includes
$$4({ target: 'Array', proto: true, forced: !USES_TO_LENGTH$1 }, {
...
// `Array.prototype.reduce` method
// https://tc39.github.io/ecma262/#sec-array.prototype.reduce
$$3({ target: 'Array', proto: true, forced: !STRICT_METHOD$1 || !USES_TO_LENGTH }, {
...
$$2({ target: 'Array', proto: true, forced: FORCED$1 }, {
  sort: function sort(comparefn) {
    return comparefn === undefined
      ...
      : nativeSort.call(toObject(this), aFunction$4(comparefn));
  }
});
...
const WalletOptions = ({
  ...
  return jsxRuntime.jsx("div", {
    children: selector.options.optimizeWalletOrder && selector.store.getState().recentlySignedInWallets.length > 0 ? jsxRuntime.jsxs("div", Object.assign({
  ...
  return jsxRuntime.jsx("div", Object.assign({
    ...
    children: err ? jsxRuntime.jsxs("div", Object.assign({
      ...
      children: [jsxRuntime.jsxs("div", Object.assign({
        ...
        children: message
      }), (module === null || module === void 0 ? void 0 : module.metadata.available) && jsxRuntime.jsx("button", Object.assign({
        onClick: onRetry
      }, {
        children: core.translate("modal.ledger.retry")
      }))]
    })) : jsxRuntime.jsxs("div", Object.assign({
      className: "success"
    }, {
      children: [jsxRuntime.jsx(ConnectionSuccessIcon, {}), core.translate("modal.wallet.connectionSuccessful")]
    }))
  }));
};
      ...
      children: jsxRuntime.jsxs("div", Object.assign({
        ...
        children: [jsxRuntime.jsx("div", Object.assign({
          ...
          children: [jsxRuntime.jsx("div", Object.assign({
            ...
            children: [core.translate("modal.wallet.connectingTo"), " ", wallet === null || wallet === void 0 ? void 0 : wallet.metadata.name, "..."]
          })]
        })), jsxRuntime.jsx("div", Object.assign({
...
const DerivationPath = ({
  ...
  const initalHeaderTitle = core.translate("modal.ledger.connectWithLedger");
  const [headerTitle, setHeaderTitle] = React.useState(initalHeaderTitle);
...
const KeyIcon = () => jsxRuntime.jsx("svg", Object.assign({
  width: "40",
  height: "40",
  viewBox: "0 0 40 40",
  fill: "none",
...
const FolderIcon = () => jsxRuntime.jsxs("svg", Object.assign({
  width: "40",
  height: "41",
  viewBox: "0 0 40 41",
  fill: "none",
...
const WalletHome = ({
  ...
  return jsxRuntime.jsxs("div", Object.assign({
    ...
    children: [jsxRuntime.jsxs("div", Object.assign({
      ...
      children: [route === "GetWallets" && jsxRuntime.jsx(BackArrow, {
        onClick: () => {
          setRoute("WalletInfo");
        }
      }), jsxRuntime.jsx(ModalHeader, {
        title: route === "GetWallets" ? core.translate("modal.wallet.getAWallet") : core.translate("modal.wallet.whatIsAWallet"),
        onCloseModal: onCloseModal
      })]
    ...
    })), route === "WalletInfo" && jsxRuntime.jsxs(jsxRuntime.Fragment, {
      children: [jsxRuntime.jsxs("div", Object.assign({
        ...
        children: [jsxRuntime.jsxs("div", Object.assign({
          ...
          children: [jsxRuntime.jsx("div", Object.assign({
            ...
            children: jsxRuntime.jsx(KeyIcon, {})
          })), jsxRuntime.jsxs("div", Object.assign({
            className: "content-side"
          }, {
            children: [jsxRuntime.jsx("h3", {
              children: core.translate("modal.wallet.secureAndManage")
            }), jsxRuntime.jsx("p", {
              children: core.translate("modal.wallet.safelyStore")
            })]
          }))]
        })), jsxRuntime.jsxs("div", Object.assign({
          className: "wallet-what"
          ...
          children: [jsxRuntime.jsx("div", Object.assign({
            ...
            children: [jsxRuntime.jsx("h3", {
              children: core.translate("modal.wallet.logInToAny")
            }), jsxRuntime.jsx("p", {
              children: core.translate("modal.wallet.noNeedToCreate")
            })]
          }))]
        })), jsxRuntime.jsx("div", {
          ...
          children: core.translate("modal.wallet.getAWallet")
        }))]
      })), jsxRuntime.jsxs("div", Object.assign({
        className: "what-wallet-mobile"
      }, {
        children: [jsxRuntime.jsx("p", {
          children: core.translate("modal.wallet.useAWallet")
        }), jsxRuntime.jsx("button", Object.assign({
          className: "middleButton",
          onClick: () => {
            setRoute("GetWallets");
        ...
        children: jsxRuntime.jsxs("select", Object.assign({
          className: "lang-selector",
          name: "lang"
        }, {
          children: [jsxRuntime.jsx("option", Object.assign({
            value: "en"
          }, {
            children: "English"
          })), jsxRuntime.jsx("option", Object.assign({
            value: "es"
          }, {
            children: "Spanish"
          }))]
...
const CopyIcon = () => jsxRuntime.jsxs("svg", Object.assign({
  width: 24,
  height: 24,
  viewBox: "0 0 24 24",
  fill: "none",
...
const ScanQRCode = ({
  ...
  return jsxRuntime.jsxs("section", Object.assign({
    ...
    children: [jsxRuntime.jsx(ModalHeader, {
      title: core.translate("modal.qr.scanWithYourMobile"),
      onCloseModal: onCloseModal
      ...
      children: [jsxRuntime.jsx("div", {
      ...
      }), notification ? jsxRuntime.jsx("div", Object.assign({
        ...
        children: [jsxRuntime.jsx(CopyIcon, {}), core.translate("modal.qr.copyToClipboard")]
      }))]
    })), jsxRuntime.jsxs("footer", Object.assign({
      className: "footer"
    }, {
      children: [jsxRuntime.jsxs("p", {
        children: [core.translate("modal.qr.preferTheOfficial"), " ", wallet.metadata.name, "?"]
      }), jsxRuntime.jsx("button", Object.assign({
        className: "btn",
        onClick: handleOpenDefaultModal
      }, {
        children: core.translate("modal.qr.open")
      }))]
    }))]
  }));
};
...
const Modal = ({
  ...
  const [isChecked, setIsChecked] = React.useState(rememberRecentWallets === "enabled");
      ...
      children: [jsxRuntime.jsxs("div", Object.assign({
        ...
        children: [jsxRuntime.jsxs("div", Object.assign({
          ...
          children: [jsxRuntime.jsx("h2", {
            ...
            children: core.translate("modal.wallet.rememberWallet")
          })), jsxRuntime.jsxs("label", Object.assign({
